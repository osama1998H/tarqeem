...
"#;
    ...
    fn test_math_functions() {
        let source = r#"
استورد { جذر، قوة، مطلق } من "رياضيات"
متغير أ = جذر(16.0)
متغير ب = قوة(2.0، 3.0)
متغير ج = مطلق(-5)
"#;
...
"#;
    ...
    fn test_random_functions() {
        let source = r#"
استورد { عشوائي، عشوائي_بين، عشوائي_منطقي } من "رياضيات"
متغير أ = عشوائي()
...
"#;
    ...
    fn test_rounding_functions() {
        let source = r#"
استورد { أرضية، سقف، تقريب } من "رياضيات"
متغير أ = أرضية(3.7)
متغير ب = سقف(3.2)
متغير ج = تقريب(3.5)
"#;
