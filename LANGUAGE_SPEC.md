...
عمليات البتات دوالٌ لا عوامل: ترقيم لا تملك رموز `&` و`|` و`^` و`~` و`<<`، وإضافتها تغييرٌ في الصياغة.
...
**مقدار الإزاحة من `٠` إلى `٦٣`، وما خرج عن ذلك يُرجع `٠`.** وهذا هو الجواب الحسابي لا
قيمةً بديلة: إزاحة عددٍ بـ٦٤ خانةً فأكثر تُخرج بتاته جميعاً خارج الأربع والستين فلا يبقى
منها شيء. والمقدار السالب ليس إزاحةً يميناً — لتلك اسمها. العملية **كليّة**: لا تتوقف
ولا ترمي، ولا تختلف فيها الخلفيات.
